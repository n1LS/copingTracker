...
enum InstrumentType { IT_NONE = 0, IT_SAMPLE, IT_MIDI, IT_SID, IT_OPAL, IT_CHIPTUNE, IT_DRUM, IT_STACK, IT_LAST };
...
public:
  ...
  virtual void ProcessCommand(int channel, Token token, uint16_t value) = 0;
